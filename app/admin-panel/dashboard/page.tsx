    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-muted rounded-lg p-6 border border-muted-foreground/20">
          <div className="text-muted-foreground text-sm font-medium">Total Programs</div>
          <div className="text-3xl font-bold mt-2">77</div>
        </div>
        <div className="bg-muted rounded-lg p-6 border border-muted-foreground/20">
          <div className="text-muted-foreground text-sm font-medium">Pending Applications</div>
          <div className="text-3xl font-bold mt-2">12</div>
        </div>
        <div className="bg-muted rounded-lg p-6 border border-muted-foreground/20">
          <div className="text-muted-foreground text-sm font-medium">Gallery Images</div>
          <div className="text-3xl font-bold mt-2">24</div>
        </div>
        <div className="bg-muted rounded-lg p-6 border border-muted-foreground/20">
          <div className="text-muted-foreground text-sm font-medium">Published Blogs</div>
