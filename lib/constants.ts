...
export const AITEC_DATA = {
  ...
  feeStructure: [
    {
      id: 1,
      programType: "Bachelor of Engineering",
      duration: "4 Years",
      tuitionPerYear: "$12,500",
      hostelPerYear: "$4,000",
      libraryAndLabs: "$800",
      activities: "$500",
      totalPerYear: "$17,800",
      totalProgram: "$71,200",
      notes: "Includes all lab materials and digital resources",
    },
    {
      id: 2,
      programType: "Bachelor of Technology",
      duration: "4 Years",
      tuitionPerYear: "$13,200",
      hostelPerYear: "$4,000",
      libraryAndLabs: "$900",
      activities: "$500",
      totalPerYear: "$18,600",
      totalProgram: "$74,400",
      notes: "Includes AI/ML software subscriptions",
    },
    {
      id: 3,
      programType: "Master's Programs",
      duration: "2 Years",
      tuitionPerYear: "$15,000",
      hostelPerYear: "$4,000",
      libraryAndLabs: "$1,000",
      activities: "$400",
      totalPerYear: "$20,400",
      totalProgram: "$40,800",
      notes: "Research funding available for selected students",
    },
    {
      id: 4,
      programType: "Diploma Programs",
      duration: "3 Years",
      tuitionPerYear: "$8,500",
      hostelPerYear: "$3,500",
      libraryAndLabs: "$600",
      activities: "$300",
      totalPerYear: "$12,900",
      totalProgram: "$38,700",
      notes: "Internship opportunities included",
    },
    {
      id: 5,
      programType: "Certificate Programs",
      duration: "6 Months",
      tuitionPerYear: "$3,500",
      hostelPerYear: "$0",
      libraryAndLabs: "$300",
      activities: "$150",
      totalPerYear: "$3,950",
      totalProgram: "$3,950",
      notes: "Online and offline options available",
    },
  ],
  ...
  documents: [
    {
      id: 1,
      title: "AITEC Prospectus 2024-25",
      description:
        "Complete information about all programs, facilities, and admissions process",
      fileSize: "2.4 MB",
      fileType: "PDF",
      category: "general",
      downloadUrl: "#",
    ...
    },
    {
      ...
      description:
        "Comprehensive guide on scholarships, loans, and financial assistance options",
      fileSize: "1.8 MB",
      fileType: "PDF",
      category: "financial",
      downloadUrl: "#",
    ...
    },
    {
      ...
      description:
        "Rules, regulations, code of conduct, and campus policies for students",
      fileSize: "3.2 MB",
      fileType: "PDF",
      category: "academic",
      downloadUrl: "#",
    ...
    },
    {
      ...
      description:
        "Details on merit-based and need-based scholarships available to students",
      fileSize: "1.5 MB",
      fileType: "PDF",
      category: "financial",
      downloadUrl: "#",
    ...
    },
    {
      ...
      description:
        "Guidelines for ethical behavior, discipline procedures, and student rights",
      fileSize: "0.9 MB",
      fileType: "PDF",
      category: "academic",
      downloadUrl: "#",
    ...
    },
    {
      ...
      description:
        "Details about hostel facilities, accommodation options, and booking process",
      fileSize: "2.1 MB",
      fileType: "PDF",
      category: "general",
      downloadUrl: "#",
    ...
    {
      id: 8,
      title: "Internship & Placement Guide",
      description:
        "Information about internship opportunities, placement process, and career support",
      fileSize: "2.7 MB",
      fileType: "PDF",
      category: "academic",
      downloadUrl: "#",
  ...
  events: [
    {
      ...
      type: "competition",
      description:
        "Experience the vibrant campus culture with student performances, club showcases, and interactive activities. ",
      image: "/coastal.jpg",
      status: "upcoming",
    },
    {
      id: 2,
      title: "Hair Dressing and Beauty Therapy",
      date: "March 20-22, 2025",
      time: "9:00 AM - 5:00 PM",
      location: "Convention Center",
      type: "program",
      description:
        "Join our intensive workshop on hair dressing and beauty therapy, featuring expert stylists and hands-on training sessions.",
      image: "/hair1.jpg",
      status: "upcoming",
    },
    {
      ...
      type: "students",
      description:
        "Hear from our successful alumni about their journey from AITEC to their dream careers. Panel discussions, networking opportunities, and career advice sessions included.",
      image: "/kmtc2.jpg",
      status: "upcoming",
    },
    {
      id: 4,
      title: "Practical Electrical Engineering Workshop",
      date: "April 5, 2025",
      time: "10:00 AM",
      location: "Campus Grounds",
      type: "program",
      description:
        "Join us for a hands-on workshop on practical electrical engineering, where students will engage in real-world projects and learn from industry experts.",
      image: "/electric1.jpg",
      status: "upcoming",
    },
  ],
